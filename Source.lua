...
function library.changeMenuBind(BindName)
    if table.find(UserInputTypeBinds, BindName) ~= nil then
        MenuBind = Enum.UserInputType[BindName]
    else
        MenuBind = Enum.KeyCode[BindName]
    end
end
