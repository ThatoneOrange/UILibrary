...
function library.changeMenuBind(Keybind)
    local str = tostring(Keybind)
    if table.find(KeybindsStateType, str) ~= nil then
        MenuBind = Enum.UserInputType[str]
    else
            ...
            function section.new_sector(sector_name, sector_side)
                ...
                function sector.element(type, text, data, callback, c_flag)
                    ...
                    elseif type == "Dropdown" then
                        ...
                        function element:update(table)
                            for i,v in pairs(DropdownScroll:GetChildren()) do
